...
<h1 className='flex justify-center font-bold text-4xl w-[100%] lg:w-[30rem] tracking-[.25em]'>Our <span> Process</span> </h1>  
     ...
     <p className='w-[16rem] lg:w-[30rem] text-lg my-10'>At Mantech, we believe that process needs to be simple, organized, and transparent, so we create eight steps </p>
