    ...
    <div className=" mx-auto p-6  w-[100vw]    bg-gray-100" >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 lg:bg-[url('/ser.png')] bg-no-repeat bg-center bg-[length:19rem_15rem]">
        <div className="     rounded-md p-6 text-center flex items-center flex-col">
          ...
          <p className='w-[20rem] text-start'>Crafting seamless and captivating digital experiences through user-centered design.</p>
        </div>
        <div className="     rounded-md p-6 text-center flex items-center flex-col">
         
          <h3 className="text-xl font-bold mb-2">Reliable Hosting</h3>
          <p className=' w-[20rem]  flex p-4 text-start '>High-speed, secure hosting with 24/7 support. Maximum uptime and scalability guaranteed.</p>
        </div>
        <div className="     rounded-md p-6 text-center flex items-center flex-col">
       
          <h3 className="text-xl font-bold mb-2">App Development</h3>
          <p className='w-[20rem] text-start'>Designing engaging and user-centric app interfaces that captivate and delight users.</p>
        </div>
        <div className="     rounded-md p-6 text-center flex items-center flex-col">
          
          <h3 className="text-xl font-bold mb-2">Web Development</h3>
          <p className='w-[20rem] text-start'>Bringing visual concepts to life with innovative and impactful designs as a web developer.</p>
        </div>
      </div>
    </div>
  );
